...
<head>
  ...
  <!-- Variáveis JS -->
  <script>
    var pagina_actual = <?= json_encode($pagina_actual); ?>;    
    var scroll_destaques = <?= json_encode($scroll_destaques); ?>;    
  </script>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav navbar-mobile m-auto mb-2 mb-lg-0 navbar-espacamento-interno align-items-end">   
                ...
                <li class="nav-item dropdown" >
                  <a onmouseenter="clickEmpreendimentos()" id="nav-link-mobile" class="nav-link text-uppercase poppins-medium empreendimento <?= ($pagina_actual == "empreendimento") ? "active" : ""; ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Empreendimentos
                  </a>
