  ...
  <?php if(!empty($destaque_unico)): ?>
    ...
    <div class="row justify-content-end">
      <div class="col-lg-6 col-12 text-center my-4 mt-lg-5">
        <a id="link_destaques" href="destaques.php?pagina=<?= ($pagina == null) ? "1" : $pagina; ?>&scroll=0#<?= $id; ?>" class="botao-destaque text-uppercase text-decoration-none cinza-escuro poppins-regular">Voltar Para Destaques</a>
      </div>
    </div>
