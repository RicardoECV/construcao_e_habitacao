...
<main class="container-fluid px-0">
  ...
  <div class="row d-flex flex-wrap justify-content-center gap-xl-4 gap-4 pt-xl-4 px-xl-0 mx-0">
    ...
    <?php foreach($destaques as $d): ?>
      ...
      <div id="<?= $d["id"]; ?>" class="col-xl-4 col-sm-6 col-10 px-1 pb-4">
        <div class="card card-top h-100 border-0">
          ...
          <div class="card-body card-body-destaques d-flex flex-column poppins-regular cinza-escuro p-0">            
            ...
            <a href="destaque_unico.php?id=<?= $d["id"] ?>&pagina=<?= $pagina; ?>" class="text-decoration-none cinza-escuro botao-ver-mais-card m-auto text-uppercase d-flex justify-content-center align-items-center align-self-center">Ver Mais</a>    
          </div>          
        </div> 
      </div> 
